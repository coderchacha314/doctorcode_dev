...
export default function LiverPage(): React.ReactElement {
  ...
  async function handleScan(e: React.ChangeEvent<HTMLInputElement>): Promise<void> {
    ...
    try {
      ...
      const res = await fetch("/api/readings/liver/scan", {
        method: "POST",
      ...
      if (extracted.alt != null) setFormAlt(String(extracted.alt));
      if (extracted.ast != null) setFormAst(String(extracted.ast));
      if (extracted.alp != null) setFormAlp(String(extracted.alp));
      if (extracted.bilirubin != null) setFormBilirubin(String(extracted.bilirubin));
      if (extracted.albumin != null) setFormAlbumin(String(extracted.albumin));
